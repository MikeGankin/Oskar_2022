...
const bannerAnimation = () => {
  ...
  gsap_CustomEase__WEBPACK_IMPORTED_MODULE_1__.CustomEase.create('cubic', '.250, .460, .450, .940');
  tl.to(oskar, {
    y: 0,
    opacity: 1,
    duration: 0.4,
...
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_CustomEase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/CustomEase */ "./node_modules/gsap/CustomEase.js");
/* harmony import */ var _debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./debounce */ "./src/js/functions/debounce.js");


gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.registerPlugin(gsap_CustomEase__WEBPACK_IMPORTED_MODULE_1__.CustomEase);
 // Таймлайны

let menuTl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
let langTl = gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline();
gsap_CustomEase__WEBPACK_IMPORTED_MODULE_1__.CustomEase.create('cubic', '.250, .460, .450, .940'); // Переменные
...
const debouncedMenuAnimation = (0,_debounce__WEBPACK_IMPORTED_MODULE_2__.debounce)(menuAnimation, 200);
const debouncedLangMenuAnimation = (0,_debounce__WEBPACK_IMPORTED_MODULE_2__.debounce)(langMenuAnimation, 200);
...
/* harmony import */ var _functions_banner_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/banner-animation */ "./src/js/functions/banner-animation.js");
...
const macOsDetector = /(Mac|iPhone|iPod|iPad)/i.test(navigator.platform); // Конструкторы
// Управление скроллом
