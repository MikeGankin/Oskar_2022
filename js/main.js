...
/* harmony import */ var _functions_text_limiter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/text-limiter */ "./src/js/functions/text-limiter.js");
...
let tocLinks = document.querySelectorAll('.table-of-content__link'); // Управление скроллом
...
const textCollapser = e => {
  ...
  if (target.tagName === 'BUTTON') {
    if (target.parentNode.querySelector('.limiter').hasAttribute('data-collapsed')) {
      ...
      (0,_functions_text_limiter__WEBPACK_IMPORTED_MODULE_4__.expandSection)(target.parentNode.querySelector('.limiter'));
      target.textContent = 'Read less';
    } else {
      target.parentNode.querySelector('.limiter').setAttribute('data-collapsed', '');
      (0,_functions_text_limiter__WEBPACK_IMPORTED_MODULE_4__.collapseSection)(target.parentNode.querySelector('.limiter'));
