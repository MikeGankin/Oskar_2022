...
/***/ "./src/js/functions/banner-animation.js":
/*!**********************************************!*\
  !*** ./src/js/functions/banner-animation.js ***!
  \**********************************************/
...
const bannerAnimation = () => {
  ...
  oskar.style.animationName = 'slideInBanner';
};
...
/***/ "./src/js/functions/text-limiter.js":
/*!******************************************!*\
  !*** ./src/js/functions/text-limiter.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const collapseSection = element => {
  ...
  element.style.transition = ''; // на следующем кадре (как только предыдущий стиль применится),
...
const textCollapser = e => {
  ...
  if (target.parentElement.querySelector('.limiter').hasAttribute('data-collapsed')) {
    ...
    if (lang === 'ru') {
      target.textContent = 'Cкрыть подробности';
    }
...
/* harmony import */ var _functions_menu_animation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/menu-animation */ "./src/js/functions/menu-animation.js");
/* harmony import */ var _functions_player__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/player */ "./src/js/functions/player.js");
...
/* harmony import */ var _functions_text_limiter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/text-limiter */ "./src/js/functions/text-limiter.js");
/* harmony import */ var _functions_vh_mobile__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./functions/vh-mobile */ "./src/js/functions/vh-mobile.js");
...
scrollUpObserver.observe(footer); // Слежка за пересечением вьюпорта для смены цвета скрол-бара
...
scrollBarObserver.observe(footer); // Проверка девайса
